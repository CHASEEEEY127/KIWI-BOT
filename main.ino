...
//vars and defs
  //motor definitions
    ...
    Motor_L928N motor1= Motor_L928N(25,32,33);
...
Motor_L928N motor2= Motor_L928N(5,18,19);
...
Motor_L928N motor3= Motor_L928N(27,14,26);
...
//toggle feild orientation and heading correction
  ...
  //if heading correction
    //heading correction
      ...
      kiwiDrive(ps5.LStickY()*2,ps5.LStickX()*2,pidLoop(headingIn,heading,headingP,headingI,headingD,&headingIO,false,2.0,&ITimer,100,&Perror,&error),heading);
  ...
  //set motors
    motor1.set(motor1_Speed);
    motor2.set(motor2_Speed);
    motor3.set(motor3_Speed);
